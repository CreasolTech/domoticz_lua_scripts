...
GENERATOR_DEVS={'PV_PowerMeter', 'PVTracker_PowerMeter'}	-- Empty => no generators available (photovoltaic, wind, ...).  {'Inverter_Power'} => only one generator named 'Inverter_Power'
...
if (devicechanged[GRID_DEV]~=nil) then
	...
	--print('Power2P1: Input power='..powerin..'W Output power='..powerout)	-- show input/output power
	--print('Power2P1: energy='..energy..'Wh energyOld='..energyOld..'Wh energyDiff='..energyDiff..'Wh => Update P1 meter with values '..str) -- show energy
