...
![alt Variables in CSV format with electriciy hourly price and solar photovoltaic forecast](https://images.creasol.it/heatpump_optimized_electricity_solar_forecast.webp?2 "Variables in CSV format with electriciy hourly price and solar photovoltaic forecast, suitable to control heat pump, EV charging, boiler, ... to optimize own consumption and reduce peak hours energy usage")
