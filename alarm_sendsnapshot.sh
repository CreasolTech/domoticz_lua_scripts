...
#				convert -geometry 960 /tmp/alarm_snapshot1_$$.jpg /tmp/alarm_snap.jpg
				...
				datetime=`date "+%x %T"`
				#${TELEGRAMSCRIPT} ${TELEGRAMCHATID} "${datetime} - ${message}" /tmp/alarm_snap.jpg
				${TELEGRAMSCRIPT} ${TELEGRAMCHATID} "${datetime} - ${message}" 'none' /tmp/alarm_snapshot1_$$.mp4
...
#				convert -geometry 960 /tmp/alarm_snapshot2_$$.jpg /tmp/alarm_snap.jpg
				...
				datetime=`date "+%x %T"`
				#${TELEGRAMSCRIPT} ${TELEGRAMCHATID} "${datetime} - ${message}" /tmp/alarm_snap.jpg
				${TELEGRAMSCRIPT} ${TELEGRAMCHATID} "${datetime} - ${message}" 'none' /tmp/alarm_snapshot2_$$.mp4
